...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.find<Cart_controller>().getCartData();
    return GetBuilder<Popular_product_controller>(builder: (_){
      return GetBuilder<Recommanded_product_controller>(builder: (_){
        return   GetMaterialApp(
          debugShowCheckedModeBanner: false,
          title: 'Flutter Demo',
          //home: Sign_in(),
          initialRoute: Road_Helper.getSplash(),
          getPages: Road_Helper.routes,
        );
      });
    });
  }
